...
# Criticisms
The open letter published against him also covered numerous other opinions from Stallman that it considered problematic in its appendix. It argues that he is transphobic due to advocating for people to not use the words "they", "them" and "their(s)" as singular gender-neutral pronouns, as he believes they are plural, and highlights his opinions about Down's syndrome: calling women carrying fetuses with it "perverse", believing that "the right course of action [...] is to terminate the pregnancy" for a women carrying a fetus likely to have it, comparing people with Down's syndrome to pets, and agreeing that women should "abort it and try again". The website in support of Stallman, stallmansupport.org, has argued against Stallman being transphobic by referring to him calling for action in support of rights for transgender people, and how he uses the singular gender-neutral pronouns per and pers for that purpose. His opinions made their way into GNU's Kind Communications Guidelines, where a footnote states, 'There are various ways to express gender neutrality in third-person singular pronouns in English; you do not have to use “they.”'. It has since been edited in 2021 to include they, them and theirs, but Stallman's opinion about the words stayed the same and is still voiced on his website as of 2024.
