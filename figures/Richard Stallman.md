...
## XEmacs
In 2000, amidst debates about the split between GNU Emacs and XEmacs, Jamie Zawinski released his account on the subject. He recounts that while working at Lucid Inc., he was helping develop Energize, an integrated development environment for C/C++ on Unix. The company needed to put together a compiler, a linker, a debugger, a grapher, and an editor; they decided that the most powerful tool to do so was Emacs. They decided to go with GNU Emacs which had version 19 about to come out. Lucid Inc. decided to not use the current version 18, or Epoch, which was a fork of GNU Emacs with more features that was "considered an interim approach until Emacs 19 came out", as it believed those codebases were considered obsolete and wanted something that was working out of the box, already new and already used by the wider public, so they decided to contribute to GNU Emacs, even licensing their code under GPL. According to Zawinski, their efforts to colaborate with the Free Software Foundation were "a disaster", and the company decided they "couldn't wait any longer", taking their contributed code and calling it Lucid Emacs while shipping it as-is. He also released the internal e-mails between the company and the FSF.

In December 6, 2004, Ben Wing decided to add his own account of the story, putting it in XEmacs's internals 4 documentation file under 21.5, where a guide to XEmacs's features previously lied.

As late as December 12th, 2005, Stallman objected to the claim that he refused cooperation. He says that GNU's Emacs programmer was hired away by Lucid Inc., then leaving GNU and giving "two weeks notice".

## Virgin of Emacs
In some of Stallman's speeches, while characterized as St. IGNUcius, he brings up the "Virgin of Emacs", referencing the Virgin Mary. In 2009, a person criticized him for her gender being solely female, perceiving it as a criticism against women. While it was not his intention, Stallman still heeded the criticism and decided to make the Virgin of Emacs gender-neutral.

## Open letter
The open letter published against him also covered other opinions from Stallman that it considered problematic in its appendix. It argues that he is transphobic due to advocating for people to not use the words "they", "them" and "their(s)" as singular gender-neutral pronouns, as he believes they are solely plural, and highlights his opinions about Down syndrome: calling women carrying fetuses with it "perverse", believing that "the right course of action […] is to terminate the pregnancy" for a women carrying a fetus likely to have it, comparing people with Down's syndrome to pets, and agreeing that women should "abort it and try again".

Stallmansupport.org has argued against Stallman being transphobic by referring to him calling for action in support of rights for transgender people, and how he uses the singular gender-neutral pronouns per and pers for that purpose.

His opinions made their way into GNU's Kind Communications Guidelines, where a footnote states, 'There are various ways to express gender neutrality in third-person singular pronouns in English; you do not have to use “they.”'. It has since been edited in 2021 to include they, them and their(s), but Stallman's opinion about the words stayed the same, and his advocacy is still voiced on his website.

## Misogyny
A website in support of Stallman, stallmansupport.org, attempted to debunk the claims on the appendix to Gano's article; claiming that the 2004 bachelor's comment of "I recall being told early in my freshman year “If RMS hits on you, just say ‘I’m a vi user’” even if it’s not true." was merely part of a series of jokes meant to drive Stallman away because "he was seen as unattractive, clueless, and bizarre" instead of being "a monster harassing women", and that the 1999 bachelor was mistaken about the man she saw having a mattress in his office being Stallman, with it instead being professor Gerald Jay Sussman, since she cited that many "female students avoided the corridor to [Stallman]'s office for that reason", and Sussman's office was also in that corridor. Gano at one point brings up a sign on the door to Stallman's office that says "Knight for justice (and hot ladies)", as evidence for his creepiness. Sylvia Paull, a longtime friend of Stallman, has claimed that while the sign is real and was in fact on Stallman's door, it was not put up by him and was written by someone else as a joke, and that he also removed the sign himself.

Betsy S., who received a bachelor's degree in management science in 1989, told Gano for her article that she "went to a buffet lunch at an Indian restaurant in Central Square with a graduate student friend and others from the AI lab", after which she ended up with Stallman at a table, who "told me of his misery and that he’d kill himself if I didn’t go out with him." Feeling bad for him while also "uncomfortable and manipulated", not liking being responsible for an "important" man, she declined further contact. In 2020, Stallman acknowledged this and let a note to her on the political notes on his website, apologizing for the misunderstanding that he believes happened and saying she "must have misunderstood the last thing I said to her."

# Personal life
Stallman lives in Boston and moved there after living in Cambridge, Massaschusetts for many years. He speaks English, French, Spanish and some Indonesian. He has said that he is "an atheist of Jewish ancestry" and often wears a button that reads "Impeach God". He denies having Asperger's, but has sometimes speculated whether he could have a "shadow" version of it. He says he is childfree.
