...
In a letter, Turing wrote that "no doubt I shall emerge from it all a different man, but quite who I've not found out". Turing was given injections of what was then called stilboestrol (now known as diethylstilbestrol or DES), a synthetic oestrogen. The treatment rendered him impotent and caused breast tissue to form, the latter of which Turing found somewhat amusing according to his friends. The hormonal injections did not appear to have worked as expected, as Turing was still finding himself attracted to men.
...
### "Pryce's Buoy"
Circa 1953, Turing wrote an unfinished, three-page short story titled "Pryce's Buoy". It has Angus Wilson's candid, cynical, and socially aware style, much after E. M. Forster, while also revealing Turing's "playful side". Largely autobiographical, it details an erotic encounter between a male youth in need of money and a wealthy older theoretical scientist looking for casual sex. The title is a sexual pun of a fictional math equation, described by Turing within the story, sharing similarities with the Turing test. Literature professor Sarah Dillon of Cambridge University studied the story in 2026, transcribing Turing's handwritten prose from archived pages and researching its origins and intent. The story revealed a sense of humour that was not widely known prior, and news outlets reported that Turing was "cheeky, funny, and really liked sex".
