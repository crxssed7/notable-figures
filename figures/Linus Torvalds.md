...
In 2000, then CEO of Apple Steve Jobs, proposed to Linus to work on macOS, requiring him to stop his work on the Linux kernel. Linus refused, also arguing that Mach kernel was too different from the Linux one.
